...
export declare class AngularFireFunctions {
    ...
    constructor(options: FirebaseOptions, name: string | null | undefined, zone: NgZone, schedulers: ɵAngularFireSchedulers, region: string | null, origin: string | null, _useEmulator: any);
    static ɵfac: i0.ɵɵFactoryDeclaration<AngularFireFunctions, [null, { optional: true; }, null, null, { optional: true; }, { optional: true; }, { optional: true; }]>;
