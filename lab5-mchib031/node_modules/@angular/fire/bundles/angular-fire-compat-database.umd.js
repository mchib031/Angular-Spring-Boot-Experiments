(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/fire/compat'), require('firebase/compat/auth'), require('firebase/compat/database'), require('@angular/fire/compat/auth'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/database', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/fire/compat', 'firebase/compat/auth', 'firebase/compat/database', '@angular/fire/compat/auth', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.database = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.angular.fire.compat, null, null, global.angular.fire.compat.auth, global.firebase));
}(this, (function (exports, i0, rxjs, operators, i1, compat, auth, database, i2, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireDatabase = /** @class */ (function () {
        ...
        tenantId, languageCode, useDeviceLanguage, persistence) {
            ...
            this.database = i1.ɵcacheInstance(app.name + ".database." + databaseURL, 'AngularFireDatabase', app.name, function () {
