(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/fire/compat'), require('firebase/messaging'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/messaging', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/fire/compat', 'firebase/messaging', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.messaging = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.angular.fire.compat, global.messaging, global.firebase));
}(this, (function (exports, i0, rxjs, operators, i1, compat, messaging, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireMessaging = /** @class */ (function () {
        ...
        platformId, zone, schedulers, vapidKey, _serviceWorker) {
            ...
            var messaging$1 = rxjs.of(undefined).pipe(operators.subscribeOn(schedulers.outsideAngular), operators.observeOn(schedulers.insideAngular), operators.switchMap(messaging.isSupported), operators.switchMap(function (supported) { return supported ? rxjs.of(undefined) : rxjs.EMPTY; }), operators.map(function () { return compat.ɵfirebaseAppFactory(options, zone, name); }), operators.switchMap(function (app) { return i1.ɵcacheInstance(app.name + ".messaging", 'AngularFireMessaging', app.name, function () { return __awaiter(_this, void 0, void 0, function () {
