(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/core'), require('@angular/fire/compat'), require('firebase/compat/storage'), require('@angular/common'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/storage', ['exports', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/core', '@angular/fire/compat', 'firebase/compat/storage', '@angular/common', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.storage = {}), global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.core, global.angular.fire.compat, null, global.ng.common, global.firebase));
}(this, (function (exports, rxjs, operators, i1, i0, compat, storage, common, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireStorage = /** @class */ (function () {
        ...
        platformId, zone, schedulers, maxUploadRetryTime, maxOperationRetryTime, _useEmulator) {
            ...
            this.storage = i1.ɵcacheInstance(app.name + ".storage." + storageBucket, 'AngularFireStorage', app.name, function () {
    ...
    GetDownloadURLPipe.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.3", ngImport: i0__namespace, type: GetDownloadURLPipe, deps: [{ token: AngularFireStorage }, { token: i0__namespace.ChangeDetectorRef }], target: i0__namespace.ɵɵFactoryTarget.Pipe });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.3", ngImport: i0__namespace, type: GetDownloadURLPipe, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: AngularFireStorage }, { type: i0__namespace.ChangeDetectorRef }]; } });
