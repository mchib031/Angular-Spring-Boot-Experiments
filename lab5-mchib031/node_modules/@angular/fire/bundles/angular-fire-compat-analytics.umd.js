(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/fire/compat'), require('@angular/fire'), require('firebase/analytics'), require('firebase/compat/app'), require('@angular/router'), require('@angular/platform-browser'), require('@angular/fire/compat/auth')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/analytics', ['exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/fire/compat', '@angular/fire', 'firebase/analytics', 'firebase/compat/app', '@angular/router', '@angular/platform-browser', '@angular/fire/compat/auth'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.analytics = {}), global.ng.core, global.rxjs, global.ng.common, global.rxjs.operators, global.angular.fire.compat, global.angular.fire, global.analytics, global.firebase, global.ng.router, global.ng.platformBrowser, global.angular.fire.compat.auth));
}(this, (function (exports, i0, rxjs, common, operators, i1, i2, analytics, firebase, i2$2, i3, i2$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireAnalytics = /** @class */ (function () {
        ...
        platformId, zone, schedulers) {
            ...
            var analytics$1 = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(analytics.isSupported), operators.switchMap(function (supported) { return supported ? zone.runOutsideAngular(function () { return rxjs.of(undefined); }) : rxjs.EMPTY; }), operators.map(function () {
                return i2.ɵcacheInstance("analytics", 'AngularFireAnalytics', app.name, function () {
    ...
    var ScreenTrackingService = /** @class */ (function () {
        ...
        platformId, zone, userTrackingService) {
            ...
            zone.runOutsideAngular(function () {
                var activationEndEvents = router.events.pipe(operators.filter(function (e) { return e instanceof i2$2.ActivationEnd; }));
                _this.disposable = activationEndEvents.pipe(operators.switchMap(function (activationEnd) {
                    ...
                    if (component) {
                        if (component === i2$2.ɵEmptyOutletComponent) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.3", ngImport: i0__namespace, type: ScreenTrackingService, decorators: [{
            ...
            return [{ type: AngularFireAnalytics }, { type: i2__namespace$2.Router, decorators: [{
                            ...
                            type: i0.Optional
                        }] }, { type: i0__namespace.ComponentFactoryResolver }, { type: Object, decorators: [{
                            type: i0.Inject,
                            args: [i0.PLATFORM_ID]
                        }] }, { type: i0__namespace.NgZone }, { type: UserTrackingService, decorators: [{
                            type: i0.Optional
                        }] }];
        } });
