(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('firebase/compat/functions'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire/compat'), require('@angular/fire'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/functions', ['exports', 'firebase/compat/functions', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire/compat', '@angular/fire', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.functions = {}), null, global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire.compat, global.angular.fire, global.firebase));
}(this, (function (exports, functions, i0, rxjs, operators, compat, i1, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireFunctions = /** @class */ (function () {
        function AngularFireFunctions(options, name, zone, schedulers, region, origin, _useEmulator) {
            var useEmulator = _useEmulator;
            var functions = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(function () { return rxjs.of(undefined); }), operators.map(function () { return compat.ɵfirebaseAppFactory(options, zone, name); }), operators.map(function (app) { return i1.ɵcacheInstance(app.name + ".functions." + (region || origin), 'AngularFireFunctions', app.name, function () {
                var functions;
                if (region && origin) {
