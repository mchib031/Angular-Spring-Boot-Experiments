(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('firebase/compat/auth'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/fire/compat'), require('@angular/common'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/auth', ['exports', 'firebase/compat/auth', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/fire/compat', '@angular/common', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.auth = {}), null, global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.angular.fire.compat, global.ng.common, global.firebase));
}(this, (function (exports, auth, i0, rxjs, operators, i1, compat, common, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ɵauthFactory = function (app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence) { return i1.ɵcacheInstance(app.name + ".auth", 'AngularFireAuth', app.name, function () {
        var e_1, _a;
