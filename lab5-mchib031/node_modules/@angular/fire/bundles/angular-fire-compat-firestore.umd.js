(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/fire'), require('rxjs/operators'), require('@angular/fire/compat'), require('@angular/common'), require('firebase/compat/auth'), require('firebase/compat/firestore'), require('@angular/fire/compat/auth'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/firestore', ['exports', '@angular/core', 'rxjs', '@angular/fire', 'rxjs/operators', '@angular/fire/compat', '@angular/common', 'firebase/compat/auth', 'firebase/compat/firestore', '@angular/fire/compat/auth', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat.firestore = {}), global.ng.core, global.rxjs, global.angular.fire, global.rxjs.operators, global.angular.fire.compat, global.ng.common, null, null, global.angular.fire.compat.auth, global.firebase));
}(this, (function (exports, i0, rxjs, i1, operators, compat, common, auth, firestore, i2, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFirestore = /** @class */ (function () {
        ...
        tenantId, languageCode, useDeviceLanguage, persistence) {
            ...
            _a = __read(i1.ɵcacheInstance(app.name + ".firestore", 'AngularFirestore', app.name, function () {
