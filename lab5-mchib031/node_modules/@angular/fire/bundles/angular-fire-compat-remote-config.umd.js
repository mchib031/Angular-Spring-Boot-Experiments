(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/fire/compat'), require('@angular/common'), require('firebase/compat/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/compat/remote-config', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/fire/compat', '@angular/common', 'firebase/compat/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.compat = global.angular.fire.compat || {}, global.angular.fire.compat['remote-config'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.angular.fire.compat, global.ng.common, global.firebase));
}(this, (function (exports, i0, rxjs, operators, i1, compat, common, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireRemoteConfig = /** @class */ (function () {
        ...
        platformId) {
            this.zone = zone;
            var remoteConfig$ = rxjs.of(undefined).pipe(operators.observeOn(schedulers.outsideAngular), operators.switchMap(function () { return common.isPlatformBrowser(platformId) ? rxjs.of(undefined) : rxjs.EMPTY; }), operators.switchMap(function () { return import('@firebase/remote-config'); }), operators.map(function () { return compat.ɵfirebaseAppFactory(options, zone, name); }), operators.map(function (app) { return i1.ɵcacheInstance(app.name + ".remote-config", 'AngularFireRemoteConfig', app.name, function () {
