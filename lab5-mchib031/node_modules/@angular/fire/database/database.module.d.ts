...
export declare function databaseInstanceFactory(fn: () => FirebaseDatabase): (zone: NgZone) => Database;
...
export declare function provideDatabase(fn: () => FirebaseDatabase): ModuleWithProviders<DatabaseModule>;
